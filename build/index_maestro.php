    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="jumbotron">
                      ...
                      <p>Haz iniciado como maestro. <br> Que quieres hacer:</p>
                      <a type="button" class="btn btn-secondary btn-lg" href="add_alumno.php">Agregar alumnos</a>
                      <a type="button" class="btn btn-secondary btn-lg" href="add_materias.php">Agregar materias</a>
                      <a type="button" class="btn btn-secondary btn-lg" href="ver_alumnos.php">Ver alumnos</a>
                      <a type="button" class="btn btn-secondary btn-lg" href="ver_materias.php">Ver materias</a>
                    </div>
        </div>
        <!-- /page content -->
